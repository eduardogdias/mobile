                    ...
                    { () =>
                        <View style={{flex: 5}}>
                            ...
                            <FlatList data={contatoLista} style={{flex: 1}}
                                ...
                                return (
                                    <View style={{backgroundColor: "lightyellow", borderColor: "red", borderWidth: 1, padding: 5, margin: 5, flexDirection:'row', justifyContent:"space-between"}}>
                                        <View>
                                            <Text>{item.nome}</Text>
                                        ...
                                        <View style={{flexDirection: "row", width: 80, justifyContent:'space-between', margin: 10}}>
                                            <Icon name="trash" size={28} color="red" onPress={()=>{ apagar( item.id??"" ) }}/> 
                                            <Icon name="edit" size={28} color="blue" onPress={()=>{ atualizar( item.id??"" ) }}/>                                                
                                        </View>
                                    </View>
                                );
                            }} />
