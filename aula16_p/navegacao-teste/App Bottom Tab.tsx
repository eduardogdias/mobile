...
import { Entypo } from '@expo/vector-icons'; //importando o icone da home (casinha)
...
const TelaB = ( props : ParamListBase ) : React.ReactElement => { 
  return (
    <View style={{flex: 1, backgroundColor: "lightcyan", justifyContent: "center", alignItems: "center"}}>
      <Text>Tela B</Text>
      ...
      <View style={styles.container}>
        ...
        <Navigator  initialRouteName="tela_a" screenOptions={{
          ...
          <Screen name="tela_a" component={TelaA} options={{
            ...
            //tabBarIcon: ( obj ) =>  <Entypo name='home' size={obj.size} color={obj.color}/> 
            tabBarIcon: ({color, size, focused}) => <Entypo name="home" size={size} color={color}/>
          }}/>
